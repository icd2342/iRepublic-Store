...
const ProductCard = ({ model, image, price, storage, colors, colorData }) => {
  ...
  const handleBuy = () => {
    const message = `Здравствуйте! Интересует б/у ${model} ${selectedStorage} ${selectedColor.name} за ${price} ${settings.currency}`;
...
const StoreUsedModal = ({ isOpen, onClose }) => {
  ...
  const features = [
    {
      icon: "/icons/ios.svg",
      title: "Б/У устройства",
      description: "Проверенные устройства с гарантией"
    },
    {
    ...
    },
    {
      ...
      title: "Состояние",
      description: "Подробное описание состояния"
    },
    {
      icon: "/icons/accessories.svg",
      title: "Гарантия",
      description: "Гарантия на все б/у устройства"
    },
    {
    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">Б/У устройства</h1>
          <p className="text-gray-400">Купить б/у устройства в iRepublic</p>
        </div>
        ...
        <div className="bg-[#1d1d1f] rounded-2xl p-6 text-center my-8">
          ...
          <p className="text-gray-400 mb-4">
            Обменяйте свое старое устройство и получите скидку на новое
          </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8 text-sm">
          ...
          <a href="#" className="text-blue-500 hover:underline">Состояние</a>
          <span className="text-gray-400">•</span>
          <a href="#" className="text-blue-500 hover:underline">Гарантия</a>
          <span className="text-gray-400">•</span>
          <a href="#" className="text-blue-500 hover:underline">Доставка</a>
          <span className="text-gray-400">•</span>
