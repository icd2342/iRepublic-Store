    ...
    <>
      <div className="flex flex-col items-center text-center">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[17px] text-black/80 mb-1">Абсолютная мощь.</p>
...
const navIcons = [
  {
    icon: "/iconapple/IMG_4697.PNG",
    title: "iOS 18",
    link: "#ios-18"
  },
  {
    icon: "/iconapple/IMG_4698.PNG",
    title: "iPhone 16",
    link: "#iphone-16"
  },
  {
    icon: "/iconapple/IMG_4701.PNG",
    title: "iPhone 15",
    link: "#iphone-15"
  },
  {
    icon: "/iconapple/IMG_4702.PNG",
    title: "Аксессуары",
    link: "#accessories"
  },
  {
  ...
  const products = [
    {
      ...
      image: "/assets/images/iphone-16.webp",
      price: 699990,
      storage: ["256GB", "512GB", "1TB"],
      colors: ["#000000", "#7D7E80", "#F5F5F0"],
      colorData: [
        { name: "Space Black", hex: "#000000" },
        { name: "Titanium", hex: "#7D7E80" },
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-[1200px] mx-auto px-4 lg:px-6 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-semibold text-black mb-3">iPhone</h1>
          ...
          <div className="relative w-full max-w-4xl mx-auto rounded-2xl overflow-hidden mb-16">
            ...
            >
              <source src="/assets/videos/iphoneDisplay.mp4" type="video/mp4" />
