    ...
    <>
      <div className="flex flex-col items-center text-center">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[17px] text-black/80 mb-1">Как новый.</p>
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-[1200px] mx-auto px-4 lg:px-6 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-semibold text-black mb-3">Б/У техника</h1>
          <p className="text-xl text-black mb-8">Качество по доступной цене.</p>
